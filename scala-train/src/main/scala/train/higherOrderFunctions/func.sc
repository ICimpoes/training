...
val minimum20: Email => Boolean = constr20(ge)
val maximum30: Email => Boolean = constr30(le)
...
val f1 = every(notSentByAnyOf(Set("1@e.com", "2@e.com")), minimumSize(10), maximum30)
val f2 = every(notSentByAnyOf(Set("2@e.com", "3@e.com")), constr20(gt), constr30(lt))
